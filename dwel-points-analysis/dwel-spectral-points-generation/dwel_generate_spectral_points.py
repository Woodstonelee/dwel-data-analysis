...
def getCmdArgs():
    ...
    p.add_argument("-n", "--nir", dest="nirfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/HFHD_20140919_C/HFHD_20140919_C_1064_cube_bsfix_pxc_update_atp2_ptcl_points.txt", help="Input point cloud file of NIR band")
    p.add_argument("-s", "--swir", dest="swirfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/HFHD_20140919_C/HFHD_20140919_C_1548_cube_bsfix_pxc_update_atp2_ptcl_points.txt", help="Input point cloud file of SWIR band")
    p.add_argument("-o", "--output", dest="outfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/tmp-test-data/HFHD_20140919_C_dual_cube_bsfix_pxc_update_atp2_ptcl_points.txt", help="Output dual-wavelength point cloud file")

    # p.add_argument("-n", "--nir", dest="nirfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140608/C/HFHD_20140608_C_1064_cube_bsfix_pxc_update_atp2_ptcl_points.txt", help="Input point cloud file of NIR band")
    # p.add_argument("-s", "--swir", dest="swirfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140608/C/HFHD_20140608_C_1548_cube_bsfix_pxc_update_atp2_ptcl_points.txt", help="Input point cloud file of SWIR band")
    # p.add_argument("-o", "--output", dest="outfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/tmp-test-data/HFHD_20140608_C_dual_cube_bsfix_pxc_update_atp2_ptcl_points.txt", help="Output dual-wavelength point cloud file")

    # p.add_argument("-n", "--nir", dest="nirfile", default=None, help="Input point cloud file of NIR band")
    # p.add_argument("-s", "--swir", dest="swirfile", default=None, help="Input point cloud file of SWIR band")
    # p.add_argument("-o", "--output", dest="outfile", default=None, help="Output dual-wavelength point cloud file")
    ...
    # p.add_argument("--ndi", dest="ndiimgfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/tmp-test-data/HFHD_20140608_C_cube_bsfix_pxc_update_atp2_ptcl_pcinfo_ndi_gapfilled.img", help="Shot-by-shot NDI image file for point intensity synthesis")
    p.add_argument("--ndi", dest="ndiimgfile", default="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/HFHD_20140919_C/HFHD_20140919_C_dual_cube_bsfix_pxc_update_atp2_ptcl_pcinfo_ndi.img", help="Shot-by-shot NDI image file for point intensity synthesis")
