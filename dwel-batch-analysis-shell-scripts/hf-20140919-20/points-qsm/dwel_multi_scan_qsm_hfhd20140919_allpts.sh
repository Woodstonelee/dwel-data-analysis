...
#$ -l mem_total=8
#$ -l h_rt=24:00:00
#$ -N dwel-multiscan-qsm-hfhd20140919-allpts
#$ -V
#$ -m ae
#$ -t 1-5
...
SUFFIXES=( \
"hfhd20140919_tree1_allpts" \
"hfhd20140919_tree2_allpts" \
"hfhd20140919_tree3_allpts" \
"hfhd20140919_tree4_allpts" \
"hfhd20140919_tree5_allpts" \
)

DIRSUFFIX=$(date '+%Y%m%d%H%M%S')
# output directory where output files are moved to
OUTDIRS=( \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/all-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/all-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/all-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/all-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/all-points/$DIRSUFFIX" \
