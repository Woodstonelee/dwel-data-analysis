...
#$ -l mem_total=8
#$ -l h_rt=24:00:00
#$ -N dwel-multiscan-qsm-hfhd20140919-woodypts-tree3
#$ -V
#$ -m ae
#$ -t 1
...
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/tree3" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
)
