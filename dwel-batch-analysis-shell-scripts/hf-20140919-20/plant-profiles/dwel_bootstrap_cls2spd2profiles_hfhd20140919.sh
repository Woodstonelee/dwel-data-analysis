...
# #$ -pe omp 4
# #$ -m ae
#$ -N dwel-bootstrap-cls2spd2profiles-hfhd20140919
#$ -e "/usr3/graduate/zhanli86/Programs/dwel-data-analysis/dwel-batch-analysis-shell-scripts/hf-20140919-20/plant-profiles/bootstrap-dump"
#$ -o "/usr3/graduate/zhanli86/Programs/dwel-data-analysis/dwel-batch-analysis-shell-scripts/hf-20140919-20/plant-profiles/bootstrap-dump"
#$ -t 1:1000
...
BOOTSTRAPOUTDIR="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140919/spectral-points-by-union/HFHD_20140919_dual_points-clustering-profiles/pgap-by-scaling/bootstrapping-classification"
