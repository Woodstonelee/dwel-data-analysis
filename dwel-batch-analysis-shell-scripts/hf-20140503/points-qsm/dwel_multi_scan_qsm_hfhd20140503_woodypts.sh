...
#$ -l mem_total=8
#$ -l h_rt=24:00:00
#$ -N dwel-multiscan-qsm-hfhd20140503-woody
#$ -V
#$ -m ae
#$ -t 1-5
...
SUFFIXES=( \
"hfhd20140503_tree1_woodypts" \
"hfhd20140503_tree2_woodypts" \
"hfhd20140503_tree3_woodypts" \
"hfhd20140503_tree4_woodypts" \
"hfhd20140503_tree5_woodypts" \
)

DIRSUFFIX=$(date '+%Y%m%d%H%M%S')
# output directory where output files are moved to
OUTDIRS=( \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140503/spectral-points-by-union/HFHD20140503-dual-points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140503/spectral-points-by-union/HFHD20140503-dual-points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140503/spectral-points-by-union/HFHD20140503-dual-points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140503/spectral-points-by-union/HFHD20140503-dual-points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
"/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140503/spectral-points-by-union/HFHD20140503-dual-points-clustering/merging/multi-scan-qsm/qsm-param-sensitivity/woody-points/$DIRSUFFIX" \
